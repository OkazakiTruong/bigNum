...
// cài đặt phép chia
//cài đạt phép chia một số lon cho một số nhỏ
const divSmallStr = (number1, number2) => {
  let div = "";
  let mod = "";
  let carry = 0;
  let tg = "";
  ...
  for (let i = 0; i < number1.length; i++) {
    ...
    let c = carry * 10 + +tg;
    carry = c % number2;
    let t = Math.floor(c / number2);
    div += t.toString();
  }
  mod = carry.toString();
  let i = 0;
  while (i < div.length - 1 && div[i] === "0") {
    i++;
  }
  div = div.substring(i);
  console.log(div);
  console.log(mod % number2);
  div = div + ()
  return { div, mod };
};
divSmallStr("555", "22");
//cài đặt phép chia một số nguyên lớn cho một số nguyên lớn
// function divStr(a, b) {
//   let div = "";
//   let remainder = "";
//   let n1 = a.length;
//   let n2 = b.length;
//   let temp = a.substring(0, n2);

//   if (n1 < n2 || (n1 === n2 && a < b)) {
//     remainder = a;
//     return { quotient: "0", remainder: remainder };
//   } else {
//     for (let i = n2; i < a.length; i++) {
//       let count = 0;
//       temp = temp + a.charAt(i);
//       while (temp.length > 1 && temp.charAt(0) === "0") {
//         temp = temp.substring(1);
//       }
//       while (temp.length > n2 || (temp.length === n2 && temp >= b)) {
//         count++;
//         temp = subStr(temp, b); // You need to implement subtractStrings function
//       }
//       div = div + count.toString();
//     }
//     remainder = temp;
...
//   return { quotient: div, remainder: remainder };
// }
